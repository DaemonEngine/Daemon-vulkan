...
class Registry:
    ...
    def apiGen(self, inputDir, outputDir):
        ...
        print( outputDir )
        with open( outputDir + 'Vulkan.h', mode = 'w', encoding = 'utf-8', newline = '\n' ) as out:
            out.write( headerStart + Globals.headerText + '#endif // VULKAN_LOADER_H' )
        
        with open( outputDir + 'Vulkan.cpp', mode = 'w', encoding = 'utf-8', newline = '\n' ) as out:
            out.write( '// Auto-generated, do not modify\n\n' )
            out.write( '#include "Vulkan.h"\n\n' )
            out.write( Globals.functionDefinitionsText )
        
        with open( outputDir + 'VulkanLoadFunctions.cpp', mode = 'w', encoding = 'utf-8', newline = '\n' ) as out:
